...
//
//        System.out.println("从阻塞队列中拿走了: " + arrayBlockQueue.take());
//        System.out.println("从阻塞队列中拿走了: " + arrayBlockQueue.take());
//        System.out.println("从阻塞队列中拿走了: " + arrayBlockQueue.take());
//        System.out.println("从阻塞队列中拿走了: " + arrayBlockQueue.take()); //main线程阻塞

        /** 这一组不会一直阻塞等待,而是阻塞一段时间,超时则退出*/
        ...
        System.out.println("等待3秒了,线程还是在阻塞,返回: " + arrayBlockQueue.offer("d", 3L, TimeUnit.SECONDS));

        System.out.println(arrayBlockQueue.poll(3L, TimeUnit.SECONDS));
        System.out.println(arrayBlockQueue.poll(3L, TimeUnit.SECONDS));
        System.out.println(arrayBlockQueue.poll(3L, TimeUnit.SECONDS));
        //等待3秒,还没有元素可以poll,就返回null
        System.out.println("等待3秒了,线程还是在阻塞: " + arrayBlockQueue.poll(3L, TimeUnit.SECONDS));
    }
